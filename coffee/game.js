...
var Building, FRAMERATE, FireTower, INTERVAL, addGameControls, addMenus, clearCanvas, currentControlCode, drawCollection, drawEverything, drawOne, endGame, gameControls, gameControlsCode, generateTerrain, imgBase, level100, levelInitialize, levelLoop, menuCode, removeGameControls, removeMenus, runLevel, runTests, setAlias, setSizes, startLoop, toGrid,
...
currentControlCode = function(message) {
  if ($(".currentControl").length > 0) {
    $('#menu').remove(".currentControl");
  }
...
gameControls = function(command) {
  if (command === "addBuilding") {
    ...
    $('#menu').append(function() {
      return currentControlCode("Place tower");
    });
  }
  if (command === "endLevel") {
